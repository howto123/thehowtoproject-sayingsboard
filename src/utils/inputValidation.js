...
export function validateInputByDbAction(dbAction, formContent){
    ...
    // settings
    const sayingMin = 10; const sayingMax = 100;
    const authorMin = 5; const autghorMax = 25;
    const topicMin = 3; const topicMax = 25;

    // define the schemas that will be tested later in the function
    
    const dbActionSchema = Yup.string().required().matches('create'||'update'||'delete');
